...
`/decide` can be also used with regex like: `indoloader? <question>: randomly answer "Yes, No" etc.`

Some other regex filters are:
`me too` | `goodmorning` | `goodnight`.

Indoloader will reply random strings accordingly when these words are used!
